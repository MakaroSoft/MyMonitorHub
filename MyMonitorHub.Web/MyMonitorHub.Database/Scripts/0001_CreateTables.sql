...
BEGIN
    CREATE TABLE [CpuUsage] (
        ...
        CONSTRAINT [FK_CpuUsage_Item] FOREIGN KEY ([ItemId]) REFERENCES [Item] ([ItemId]) ON DELETE CASCADE
    );
END
...
BEGIN
    CREATE TABLE [DiskUsage] (
        ...
        CONSTRAINT [FK_DiskUsage_Item] FOREIGN KEY ([ItemId]) REFERENCES [Item] ([ItemId]) ON DELETE CASCADE
    );
END
...
BEGIN
    CREATE TABLE [UrlSpeed] (
        ...
        CONSTRAINT [FK_UrlSpeed_Item] FOREIGN KEY ([ItemId]) REFERENCES [Item] ([ItemId]) ON DELETE CASCADE
    );
END
...
BEGIN
    CREATE TABLE [Error] (
        ...
        CONSTRAINT [FK_Error_Item] FOREIGN KEY ([ItemId]) REFERENCES [Item] ([ItemId]) ON DELETE CASCADE
    );
END
